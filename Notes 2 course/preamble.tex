...
\usepackage{tikz}
\usetikzlibrary{intersections, angles, arrows.meta, decorations.pathreplacing, quotes}
...
% Riemann's integral (DEPRECATED -- isn't used often)
...
% Darboux and Riemann (all DEPRECATED -- too specific case)
...
backgroundcolor=black!2]{quotebase}

\newenvironment{plainquote}{\begin{quote}}{\end{quote}}
\renewenvironment{quote}{\begin{quotebase}}{\end{quotebase}}
