...
\begin{definition}
	...
	Говорят, что функциональная последовательность \bt{поточечно} сходится к $ f(x) $
\end{definition}
...
\begin{proof}
	...
	\begin{equ}{lim_seq:48}
		\underimp{\eref{lim_seq:42}} |a_m - a_n| \le \veps
	\end{equ}
...
\begin{proof}
	...
	\end{equ}
	По частному случаю перехода к пределу в интеграле от параметра
