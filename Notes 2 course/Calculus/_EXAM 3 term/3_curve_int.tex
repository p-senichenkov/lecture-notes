...
\TODO{Тут нет про непрерывность}
...
\begin{proof}
	...
	\begin{equ}{first_order_curve_int:211}
		\eref{first_order_curve_int:25}, \eref{first_order_curve_int:28}, \eref{first_order_curve_int:29}, \operatorname{def}~\delta \implies \text{ при } |t'' - t'| < \delta \quad \big| f \big( \Gamma(t'') \big) - f \big( \Gamma(t') \big) \big| < \veps
	\end{equ}
	...
	\begin{equ}{first_order_curve_int:213}
		\eref{first_order_curve_int:211} \implies |f(M_k) - f(M)| < \veps
	\end{equ}
	\begin{multline*}
