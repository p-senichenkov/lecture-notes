...
\begin{enumerate}
    ...
    \begin{algo}
        ...
        \end{cases} $$
        $$ \frac{\di u}{\di x} = \frac{\di (zt^{k - \frac12})}{\di t} \cdot \frac{\di t}{\di x} = \frac{t^{k - \frac12}\dot{z} + (k - \faktor12)t^{k - \faktor32}z}{(\faktor12 - k)t^{-\faktor12 - k}} = \frac{t^{2k}}{\faktor12 - k}\dot{z} - t^{2k - 1}z $$
        Получаем уравнение
        $$ t\dot{z} + \bigg( k - \frac12 \bigg) z + a_0z^2 = c_0t, \qquad a_0 \define \bigg( \frac12 - k \bigg) a, \quad c_0 \define \bigg( \frac12 - k \bigg) c $$
        ...
        \begin{itemize}
            ...
            $$ d \define \bigg( \frac12 + k \bigg) \bigg( \frac12 - k \bigg)^{-1}c^{-1} $$
        \end{itemize}
        В результате нескольких таких замен придём к уравнению
        $$ t\dot{v_k} + \bigg( -\frac12 \bigg)v_k + a_kv_k^2 = c_kt $$
...
\section{Линейное однородное уравнение с постоянными коэффициентами}
