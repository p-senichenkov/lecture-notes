...
%%    font style (all DEPRECATED: vimTeX doesn't recognize them, save few clicks with completion)
% math
...
%%    integrals (all DEPRECATED: gives no profit, arguments are obvious,
% turns debugging braces into a nightmare)
% undefined
...
% DEPRECATED: it've been used a couple of times
