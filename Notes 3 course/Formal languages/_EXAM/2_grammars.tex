...
\begin{definition}
	...
	\begin{enumerate}
		...
		\item если узлы $ n1, n_2, \dots, n_k $ "--- прямые потомки узла $ n $, перечисленные
			слева-направо, с метками $ A_1, A_2, \dots, A_k $ соответственно, а метка узла $ n $
			есть $ A $, то $ A \to A_1 A_2 \dots A_k \in P $.
	\end{enumerate}
\end{definition}
