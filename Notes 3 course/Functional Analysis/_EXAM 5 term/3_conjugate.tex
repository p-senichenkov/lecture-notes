		...
		\item
			\begin{itemize}
				...
				\item Возьмём $ T, S \in \mathrm{Com}(X, Y) $.
					...
					$ T(B) $ относительно компактно и вполне ограничено.
...
\begin{proof}
	...
	Проверим, что $ \Set{Ty_n} $ не фундаментальна.
	Тогда в ней не будет существовать сходящейся подпоследовательности
	$ \Set{Ty_{n_k}} $ "--- \contra с $ T \in \mathrm{Com}(X) $.
	...
	\ge \frac \delta 2 $$
	Значит, последовательность $ \Set{Ty_n} $ не содержит фундаментальных подпоследовательностей.
\end{proof}
