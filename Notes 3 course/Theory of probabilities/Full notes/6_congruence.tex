...
\begin{theorem}[Леви]
    ...
    $$ \sup\limits_x \Bigl| P \Set{\frac{\xi_1 + \dots + \xi_n - na}{\sigma \sqrt n}} -
...
\begin{proof}
    ...
    $$ f(t) = f(0) + rf'(0) + \frac12 t^2 f''(0) + o(t^2) = 1 + \ii t \mathbb E \xi - \frac{t^2}2
...
\begin{definition}
    ...
    $$ \frac{\xi_1 + \dots + \xi_n}n - \frac{a_1 + \dots + a_n}n \overarr{P} 0 \quad \text{при}
    n \to \infty $$
\end{definition}
