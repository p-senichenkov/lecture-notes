...
% differential
\newcommand\di{\ensuremath{\operatorname{d} \phantom{.}}}
...
\newcommand*\vawe[1]{\ensuremath\widetilde{#1}}
...
% continuous function
\newcommand\Cont[1]{\ensuremath{\mathcal{C} \bigg( {#1} \bigg) }}
...
% \href to be used in chapter and section names
\newcommand\hstring[2]{\texorpdfstring{\href{#1}{#2}}{#2}}
